...
ORG $0003 ; interrupt service routine
ISR:
	; Joystick-Abfrage:
...
CPSU %00100000					; Interrupt aktivieren
...
BLOOP:
	...
	BCFR,EQ FLAP				; ob Vogel schon steigt							; else: steigen
	LODI,r1 $10					; Indexregister initialisieren
	IORI,R0 %01000000			; Testbit Index wurde initialisiert
	STRA,R0 FLAPFLAG
FLAP:
	...
	LODI,R1 $FF					; Index fuer FALL vorbereiten
FALL:							; fallen
